...
#undef TANGENT_RELATIONAL_OPS
  ...
  static void normalize(Tangent& x, const Tangent& y) {if (y._v!=0) x/=y;}
...
{
 return Tangent(cos(a._v), a._dv*-sin(a._v));
}

Tangent exp(const Tangent& a)
{
 return Tangent(exp(a._v), a._dv*exp(a._v));
}

Tangent pow(const Tangent& a, const double& b)
{
  double arg1 = a._v == 0.0 ? 0 : pow(a._v,b); 
  double arg2 = a._v == 0.0 ? 0 : a._dv*b*pow(a._v,b-1);
  return Tangent(arg1, arg2);
}

//This is not the perfect implementation. Assumes b is a double
Tangent pow(const Tangent& a, const Tangent& b)
{
  double arg1 = a._v == 0.0 ? 0 : pow(a._v,b._v); 
  double arg2 = a._v == 0.0 ? 0 : a._dv*b._v*pow(a._v,b._v-1);
  return Tangent(arg1, arg2);
}
