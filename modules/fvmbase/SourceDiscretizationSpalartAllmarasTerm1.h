...
#ifndef _SOURCEDISCRETIZATIONSPALARTALLMARASTERM1_H_
#define _SOURCEDISCRETIZATIONSPALARTALLMARASTERM1_H_
...
class SourceDiscretizationSpalartAllmarasTerm1 : public Discretization
{
 public:
 ...
 SourceDiscretizationSpalartAllmarasTerm1(const MeshList& meshes,
