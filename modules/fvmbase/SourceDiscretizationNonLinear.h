...
#ifndef _SOURCEDISCRETIZATIONNONLINEAR_H_
#define _SOURCEDISCRETIZATIONNONLINEAR_H_
...
class SourceDiscretizationNonLinear : public Discretization
{
 public:
 ...
 SourceDiscretizationNonLinear(const MeshList& meshes,
