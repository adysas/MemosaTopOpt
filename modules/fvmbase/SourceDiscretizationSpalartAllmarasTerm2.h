...
#ifndef _SOURCEDISCRETIZATIONSPALARTALLMARASTERM2_H_
#define _SOURCEDISCRETIZATIONSPALARTALLMARASTERM2_H_
...
class SourceDiscretizationSpalartAllmarasTerm2 : public Discretization
{
 public:
 ...
 SourceDiscretizationSpalartAllmarasTerm2(const MeshList& meshes,
...
#if !(defined(USING_ATYPE_RAPID))
	//diag[c] += 2*cellVolume[c]*source[c];
	diag[c] += 2*cellVolume[c]*source[c];
