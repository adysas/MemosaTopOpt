...
#ifndef _SOURCEDISCRETIZATIONFORCERESIDUALTOZERO_H_
#define _SOURCEDISCRETIZATIONFORCERESIDUALTOZERO_H_
...
template<class X, class Diag, class OffDiag>
  class SourceDiscretizationForceResidualToZero : public Discretization
{
 public:
 ...
 SourceDiscretizationForceResidualToZero(const MeshList& meshes,
