...
#ifndef _DIFFUSIONDISCRETIZATIONRAPID_H_
#define _DIFFUSIONDISCRETIZATIONRAPID_H_
...
template<class X, class Diag, class OffDiag>
  class DiffusionDiscretizationRapid
{
 public:
 ...
 DiffusionDiscretizationRapid( const GeomFields& geomFields,
			 Field& varField,
...
#if !(defined(USING_ATYPE_RAPID))
DiagArray& diag = matrix.getDiag();	CCAssembler& assembler = matrix.getPairWiseAssembler(faceCells);
#endif
